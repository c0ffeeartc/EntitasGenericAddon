...
public sealed class ReactToModifiedEnts_Reactive : IPerformanceTest, IToTestString
{
	public ReactToModifiedEnts_Reactive ( Int32 iterations, Int32 entsCount, Int32 entsModifyPercent, Int32 reactSystemsCount )
	{
	...
	private			List<ReactToModifiedEnts_System>	_systemReactToModifiedEnts = new List<ReactToModifiedEnts_System>();
	...
	public					void					Before					(  )
	{
		...
		{
			_systemReactToModifiedEnts.Add( new ReactToModifiedEnts_System( _context ) );
		}
	}
