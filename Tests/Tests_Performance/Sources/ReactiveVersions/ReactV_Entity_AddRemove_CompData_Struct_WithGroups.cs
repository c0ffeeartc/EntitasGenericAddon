...
public sealed class ReactV_Entity_AddRemove_CompData_Struct_WithGroups : IPerformanceTest
{
	private const			int						n						= 1000000;
	private					Entity<TestScope1>		_ent;
	private					TestCompAStructV_Scope1	_testCompAScope1;
	...
	public					void					Before					(  )
	{
		...
		var compAId					= Lookup<TestScope1,TestCompAStructV_Scope1>.Id;
		var compBId					= Lookup<TestScope1,TestCompBStructV_Scope1>.Id;
		...
		_testCompAScope1			= new TestCompAStructV_Scope1();
	}
	...
	public					void					Run						(  )
	{
		for ( var i = 0; i < n; i++ )
		{
			_ent.AddV_( _testCompAScope1 );
			_ent.RemoveV_<TestCompAStructV_Scope1>(  );
		}
	}
}